      ...
      <div className="mt-3 flex flex-col gap-7 px-4 pb-8">
        <section className="flex flex-col gap-3">
          ...
          {benefits.hasFeatured ? (
            <div
              {...carouselDrag}
              className="-mx-4 flex snap-x snap-mandatory flex-nowrap gap-3 overflow-x-auto overscroll-x-contain scroll-smooth px-4 pb-2 [touch-action:auto] [-ms-overflow-style:none] [-webkit-overflow-scrolling:touch] [scrollbar-width:none] active:cursor-grabbing md:cursor-grab [&::-webkit-scrollbar]:hidden"
            >
